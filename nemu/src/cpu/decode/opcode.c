...
instr_func opcode_entry[256] = {
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, inv, jmp_short_,
...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, inv, mul_rm2a_b, imul_rm2a_b, inv, inv};

/* 0xf7 */
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, inv, inv};

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, inv, inv, inv, push_rm_v, inv};
