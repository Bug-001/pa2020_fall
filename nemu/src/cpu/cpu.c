...
void exec(uint32_t n)
{
	...
	{
#ifdef CACHE_ENABLED
        printf("hw_mem_access_time_cache = %lld, hw_mem_access_time_no_cache = %lld, \e[0;32mCache_speedup: %f\e[0m, \e[0;32mHit_rate: %f%%\e[0m\n", hw_mem_access_time_cache, hw_mem_access_time_no_cache, (double)hw_mem_access_time_no_cache / (double)hw_mem_access_time_cache, (double)hit_in_cache / (double)total_visit * 100);
        fflush(stdout);
#endif
